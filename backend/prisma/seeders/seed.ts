...
async function main() {
  ...
  const programs: ProgramSeed[] = [
    ...
    // Add these after course-12 in your `programs: ProgramSeed[]` array.
// All assigned to Dezai institution, no facultyId (per Dhairya's instruction to ignore faculty for now).
// price values are commented — merge in once `price` field exists on Program model.

// ─── AI · 13 courses ───────────────────────────────────────────────
{ id: 'course-13', title: 'Introduction to Artificial Intelligence', description: 'A foundational few-hour course covering core AI theory and how modern AI systems work.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-13') }, // price: 199
{ id: 'course-14', title: 'AI Vocabulary & Terminology Basics', description: 'Build fluency in essential AI terminology used across the industry, in a short foundational session.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-14') }, // price: 149
{ id: 'course-15', title: 'How Large Language Models (LLMs) Work (Without the Math)', description: 'An accessible, non-technical explanation of how LLMs actually function under the hood.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-15') }, // price: 249
{ id: 'course-16', title: 'Generative AI & Prompt Engineering', description: 'Hands-on introduction to generative AI tools and prompt engineering using OpenAI and Anthropic platforms.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-16') }, // price: 399
{ id: 'course-17', title: 'Prompt Engineering for Professionals', description: 'Advanced prompt engineering techniques framed around real AI technology strategy use cases.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-17') }, // price: 449
{ id: 'course-18', title: 'Introduction to Midjourney & AI Art', description: 'Get started generating AI art using Midjourney and Stable Diffusion, a few-hour foundational course.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-18') }, // price: 349
{ id: 'course-19', title: 'Using Microsoft Copilot for Daily Productivity', description: 'Practical techniques for using Microsoft Copilot to boost everyday productivity.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-19') }, // price: 299
{ id: 'course-20', title: 'Introduction to Voice AI & Speech-to-Text', description: 'Explore voice AI and speech-to-text tools including ElevenLabs and Whisper.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-20') }, // price: 279
{ id: 'course-21', title: 'Setting Up an OpenAI API Account', description: 'A developer-basics course walking through OpenAI API account setup and first steps.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-21') }, // price: 199
{ id: 'course-22', title: 'ChatGPT & Large Language Models Mastery', description: 'A multi-day deep dive into mastering ChatGPT and large language models for real-world use.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-22') }, // price: 999
{ id: 'course-23', title: 'Generative AI for Marketing & Content Creation', description: 'A multi-day course applying generative AI tools like Midjourney, Jasper, and Runway to marketing and content workflows.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-23') }, // price: 1199
{ id: 'course-24', title: 'AI for Business Leaders & Decision Makers', description: 'A strategic, multi-day course on AI governance and decision-making for business leaders.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-24') }, // price: 1299
{ id: 'course-25', title: 'AI Ethics, Responsible AI & Governance', description: 'A multi-day exploration of AI ethics, responsible AI practices, and governance frameworks.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-25') }, // price: 899

// ─── Commerce & Digital Business · 14 courses ─────────────────────
{ id: 'course-26', title: 'Introduction to E-commerce Models', description: 'A foundational few-hour overview of core e-commerce business models.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-26') }, // price: 199
{ id: 'course-27', title: 'Principles of Digital Sales', description: 'Core principles of digital sales, covered in a short foundational session.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-27') }, // price: 249
{ id: 'course-28', title: 'Introduction to Accounting Principles', description: 'A foundational few-hour introduction to general accounting principles.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-28') }, // price: 299
{ id: 'course-29', title: 'Business Communication Basics', description: 'Essential business communication and corporate strategy fundamentals.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-29') }, // price: 199
{ id: 'course-30', title: 'Google Workspace Essentials', description: 'A hands-on, few-hour course covering essential Google Workspace tools.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-30') }, // price: 249
{ id: 'course-31', title: 'Canva for Business & AI Design', description: 'Practical Canva skills for business and AI-assisted design, in a short foundational format.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-31') }, // price: 349
{ id: 'course-32', title: 'Basic Prompt Engineering', description: 'An introductory, few-hour course on foundational prompt engineering theory.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-32') }, // price: 199
{ id: 'course-33', title: 'Generative AI for Marketing & Content Creation', description: 'A short foundational course applying OpenAI and Claude to marketing and content creation.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-33') }, // price: 449
{ id: 'course-34', title: 'Shopify Store Launch & Optimization', description: 'A practical, few-hour course on launching and optimizing a Shopify store.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-34') }, // price: 599
{ id: 'course-35', title: 'HubSpot CRM Mastery & Inbound Marketing', description: 'A multi-day mastery course covering HubSpot CRM and inbound marketing strategy.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-35') }, // price: 1299
{ id: 'course-36', title: 'Brand Building & Storytelling in the AI Era', description: 'A multi-day course on brand building and storytelling strategy for the AI era.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-36') }, // price: 899
{ id: 'course-37', title: 'Google Analytics 4 (GA4) Basics', description: 'A multi-day foundational course covering Google Analytics 4 basics.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-37') }, // price: 699
{ id: 'course-38', title: 'Social Media Platform Basics', description: 'A multi-day course covering platform fundamentals across Meta, TikTok, and LinkedIn.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-38') }, // price: 499
{ id: 'course-39', title: 'Project Management Basics', description: 'A multi-day introduction to project management using Trello and Asana.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-39') }, // price: 449

// ─── Arts, Graphic Design & Creative Technology · 9 courses ────────
{ id: 'course-40', title: 'Typography & Color Theory for Designers', description: 'A foundational few-hour course on typography and color theory for designers.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-40') }, // price: 249
{ id: 'course-41', title: 'How to Find Design Inspiration & Moodboarding', description: 'A short course on building creative inspiration and moodboarding practices.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-41') }, // price: 199
{ id: 'course-42', title: 'Understanding File Formats & Exporting for Web', description: 'Technical basics of file formats and exporting assets for web use.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-42') }, // price: 149
{ id: 'course-43', title: 'Introduction to Penpot & Vector Basics', description: 'A foundational few-hour introduction to Penpot and vector design basics.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-43') }, // price: 299
{ id: 'course-44', title: 'Introduction to AI Prompts for Vector Art', description: 'A short course on using AI prompts to generate vector art.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-44') }, // price: 349
{ id: 'course-45', title: 'AI Tools for Designers (Image Generation & Editing)', description: 'Hands-on use of AI image generation and editing tools like Midjourney and Adobe Firefly.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-45') }, // price: 449
{ id: 'course-46', title: 'Graphic Design Essentials & Branding', description: 'A multi-day mastery course covering graphic design essentials and branding theory.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-46') }, // price: 999
{ id: 'course-47', title: 'Brand Identity & Logo Design', description: 'A multi-day course focused on brand identity and vector-based logo design.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-47') }, // price: 1199
{ id: 'course-48', title: 'Social Media Graphics & Content Creation', description: 'A multi-day course on creating social media graphics using Canva and Penpot.', institutionId: instDezai.id, thumbnail: thumbnailUrl('course-48') }, // price: 699

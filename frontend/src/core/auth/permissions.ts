...
export const RoleGroups = {
  ...
  ALL: [UserRole.STUDENT, UserRole.FACULTY, UserRole.UNIVERSITY_ADMIN, UserRole.DEZAI_ADMIN],

  /** Learners who consume content */
  LEARNERS: [UserRole.STUDENT],

  /** Content creators and managers */
  CONTENT_MANAGERS: [UserRole.FACULTY, UserRole.UNIVERSITY_ADMIN, UserRole.DEZAI_ADMIN],
...
export const DEFAULT_DASHBOARD: Record<UserRole, string> = {
  [UserRole.STUDENT]: "/credentials",
  [UserRole.FACULTY]: "/university/dashboard",

  ...
  return (
    <div className="card-elevation p-6">
      <div className="flex flex-col sm:flex-row items-start gap-6">
        {/* Avatar */}
        <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-secondary text-2xl font-bold text-white flex-shrink-0">
          {user.name
            .split(" ")
            .map((n) => n[0])
            .join("")

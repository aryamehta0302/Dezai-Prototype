...
export const SuspendedInstitutionBanner: React.FC<SuspendedInstitutionBannerProps> = ({ status }) => {
  ...
  return (
    <div className="mb-6 rounded-lg border border-red-500/30 bg-red-500/10 p-4 text-red-400 backdrop-blur-md">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h4 className="font-semibold text-red-200">Institution Suspended</h4>
